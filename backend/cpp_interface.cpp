...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 18), // void()(double *, int *, int *, unsigned int, unsigned int, double *, double *, double *, float, float, unsigned int, unsigned int, unsigned int, unsigned int)
...
static void _cffi_d_cffi_iterate(double * x0, int * x1, int * x2, unsigned int x3, unsigned int x4, double * x5, double * x6, double * x7, float x8, float x9, unsigned int x10, unsigned int x11, unsigned int x12, unsigned int x13)
{
  cffi_iterate(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_cffi_iterate(PyObject *self, PyObject *args)
{
  double * x0;
  int * x1;
  int * x2;
  ...
  if (!PyArg_UnpackTuple(args, "cffi_iterate", 14, 14, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9, &arg10, &arg11, &arg12, &arg13))
    return NULL;
  ...
  x12 = _cffi_to_c_int(arg12, unsigned int);
  if (x12 == (unsigned int)-1 && PyErr_Occurred())
    return NULL;
...
#else
#  define _cffi_f_cffi_iterate _cffi_d_cffi_iterate
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "cffi_iterate", (void *)_cffi_f_cffi_iterate, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_cffi_iterate },
};
